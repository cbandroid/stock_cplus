...
void ThreadIndex::getAllIndex()
{
   // QTime t=QDateTime::currentDateTime().time();
    GlobalVar::getData(indexData,1.5,QUrl("https://push2.eastmoney.com/api/qt/ulist.np/get?&pz=20&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&fields=f14,f2,f3&secids=1.000001%2C0.399001%2C0.399006%2C100.HSI%2C100.N225%2C100.KS11%2C1.000688%2c100.TWII%2C100.SENSEX%2C100.DJIA%2C100.SPX%2C100.NDX%2C100.SX5E%2C100.GDAXI%2C100.RTS%2C100.FTSE%2C100.FCHI%2C100.AS51%2C103.YM00Y%2C104.CN00Y%2C133.usdcnh%2C122.XAU&_=1662857186403"));
    //  GlobalVar::getData(indexData,1.5,QUrl("https://push2.eastmoney.com/api/qt/ulist.np/get?&pz=20&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&fields=f14,f2,f3&secids=1.000001%2C0.399001%2C0.399006%2C100.HSI%2C100.N225%2C100.KS11%2C1.000688%2c100.TWII%2C100.DJI%2C100.DJIA%2C100.SPX%2C100.NDX%2C100.SX5E%2C100.GDAXI%2C100.RTS%2C100.FTSE%2C100.FCHI%2C100.AS51%2C103.YM00Y%2C104.CN00Y%2C133.usdcnh%2C122.XAU&_=1662857186403"));
...
void ThreadIndex::initIndexList()
{
    ...
    // for (int i=0;i<22;++i)
    //     qDebug()<<GlobalVar::mIndexList.at(i).name;
}
...
void ThreadIndex::getEastFundFlow()
{
    ...
    QList<QStringList> mFundFlowList;
    ...
    for (int i=0;i<3;++i)
    {
        ...
        if (jsonError.error == QJsonParseError::NoError)
        {
            ...
            for (int i = 0; i < data.size(); ++i)
            {
                ...
                mFundFlowList.append(dataList);
            }
        }
    }
    std::sort(mFundFlowList.begin(),mFundFlowList.end(),[](QStringList a,QStringList b){
        return a[1].toFloat()>b[1].toFloat();
    });
    GlobalVar::mFundFlowList=mFundFlowList;
}
