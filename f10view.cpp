...
F10View::F10View(GlobalVar *pGlobalVar)
{
    getF10Info = new  GetF10Info(pGlobalVar);
...
void F10View::dealWithHotRank()
{
    ...
    int nSize=getF10Info->f10QList.size();
    for (int i=0;i<nSize;++i)
    {
          int nCount=getF10Info->f10QList.at(i).count();
