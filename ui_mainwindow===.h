...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tts_setting = new QAction(MainWindow);
        tts_setting->setObjectName("tts_setting");
        ...
        QIcon icon16;
        QString iconThemeName = QString::fromUtf8("audio-volume-high");
        if (QIcon::hasThemeIcon(iconThemeName)) {
            icon16 = QIcon::fromTheme(iconThemeName);
        } else {
            icon16.addFile(QString::fromUtf8(":/new/png/png/report.png"), QSize(), QIcon::Normal, QIcon::Off);
        }
        tts_setting->setIcon(icon16);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tts_setting->setText(QCoreApplication::translate("MainWindow", "\350\257\255\351\237\263\350\256\276\347\275\256", nullptr));
