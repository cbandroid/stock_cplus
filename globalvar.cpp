...
QList<timeShareChartInfo> GlobalVar::mTimeShareChartList;
QList<timeShareChartInfo> GlobalVar::mHisTimeShareChartList;
...
int GlobalVar::upNums[4];
int GlobalVar::downNums[4];
